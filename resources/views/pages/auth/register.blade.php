...
<div data-app="passwordToggler" class="bg-white shadow max-w-lg mx-auto rounded mt-8">
    ...
    <div class="p-6">
        ...
        <div class="flex p-4 mb-4 text-sm text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400" role="alert">
            ...
            <div>
                Please use one account only. This page is for student with NO PORTAL Account yet. If ever you forgot your account follow this link: <a href="{{ url('/forgot-password') }}" class="font-bold hover:underline">Account Recovery</a>.
            </div>
        </div>
        ...
        <form method="POST" action="{{ url('/register') }}">
            ...
            <div class="relative z-0 w-full mb-6 group">
                <input type="number" name="student_id" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
            ...
            <div class="relative z-0 w-full mb-6 group">
                <input type="text" name="middlename" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                <label for="middlename" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Middlename</label>
            </div>
            ...
            <div class="relative z-0 w-full mb-6 group">
                <select name="department" id="department" class="block py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer" placeholder=" ">
            ...
            <div class="flex p-4 mb-4 text-sm text-yellow-800 rounded-lg bg-yellow-50 dark:bg-gray-800 dark:text-yellow-300" role="alert">
                ...
                <div>
                    Please make sure your information is valid and accurate, before clicking Register button, MISPELLED or swapping of name will cause you trouble in your credentials. Thank you.
                </div>
            </div>

            <button class="block w-full text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Register</button>
