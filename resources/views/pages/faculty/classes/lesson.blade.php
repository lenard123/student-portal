<div class="bg-white">
    <div class="p-4 flex justify-between">
        ...
        <fb-button @click="postLesson=true">Post New Lesson</fb-button>
    </div>
    <fb-table>
        <table-head>
            ...
            <table-row>
                ...
                <table-cell>
                    <div class="flex justify-end gap-2">
                        <a href='{{ url("/faculty/classes/{$course->id}/lessons/{$lesson->id}") }}'>View</a>
                    </div>
                </table-cell>
            </table-row>
            @endforeach
...
<modal v-if="postLesson" @close="postLesson = false">
    <template #header>
    ...
    <template #body>
        <form class="flex flex-col gap-4" method="POST" action='{{ url("/faculty/classes/{$course->id}/lesson") }}'>
            @csrf
            <fb-input label="Title" name="title"></fb-input>
            ...
            <div class="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                ...
                <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
                    ...
                    <textarea name="content" id="editor" rows="8" class="block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write an article..." required></textarea>
                </div>
            </div>
